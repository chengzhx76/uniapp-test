...
function toast(msg){
    $('.query-error').html(msg).css({'opacity':'1','display':'block','transition':'opacity 0.3s linear','-webkit-transition':'opacity 0.3s linear;'});
    setTimeout(function(){
        $('.query-error').hide('slow');
        $('.query-error').attr('style','display:none;opacity:0;');
    },2000);
}
...
(function(KYFW){
	...
	// 预售期
	KYFW.Presale_Student_Days = 30;
	KYFW.Presale_People_Days = 20;
	// 预售期段（格式：YYYY-mm-dd）
	KYFW.Presale_Student_From_Date = '0000-00-00';
	KYFW.Presale_Student_To_Date = '0000-00-00';
	KYFW.Presale_People_From_Date = '0000-00-00';
	KYFW.Presale_People_To_Date = '0000-00-00';
